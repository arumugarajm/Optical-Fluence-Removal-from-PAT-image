...
Images = dir('C:\Users\arumugaraj\Desktop\New folder\1000images\All images\*.jpg'); % Find all jpg files in current directory.
...
for k=1:length(Images)
    ...
    X = segmentRetina(input);%generate the binary image 
...
% %     Ximn(i) = Xim(E1(i),F2(i));
%  else
%      Ximn(i) =  Xim(E2(i),F1(i));%Xim(E1(i),F2(i));
% end
...
% % sensor.frequency_response = [2.25e6 61];
% 
% M = 104;
% N = 104;
...
save(['C:\Users\arumugaraj\Desktop\New folder\New folder (2)\X_' num2str(k) '.mat'],'X');
imwrite(Img,['C:\Users\arumugaraj\Desktop\New folder\New folder (3)\X_' num2str(k) '.jpg']);   
