...
def DenseUNet(input_size, filters, lr):
    ...
    X = Input(input_size)
    conv1 = Conv2D(filters * 1, (3, 3), activation=None, padding="same")(X)
    ...
    deconv4 = Conv2DTranspose(filters * 16, (2, 2), strides=(2, 2), padding="same")(conv5)
...
if __name__ == "__main__":
    model = DenseUNet((208,208,1), 32, 0.001)
    model.summary()
