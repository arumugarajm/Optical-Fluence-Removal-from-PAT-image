...
# read the data
path = r"D:\project\Dataset\New folder\*.*"
train_set_X, val_set_X, test_set_X,train_set_Y,  val_set_Y, test_set_Y = read_data(path)
...
input_size = 208
channels = 1
unet = ResUnet(input_size,channels)

# set up checkpoint
checkpoint = ModelCheckpoint(filepath='./unet_checkpoints/', save_best_only=True, save_weights_only=True,monitor='mse', mode='min',  verbose=1)
