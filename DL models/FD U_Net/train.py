...
from Denseunet import DenseUNet,avg_NSR,avg_log_SNR
...
################### create an instance of the FD U-Net model ################
...
# print few results of outputs of the FD U-Net on the training set
print_model_outputs(model, X1[:4], Z1[:4], 'Training Data')

# print few results of outputs of the FD U-Net on the validation set
