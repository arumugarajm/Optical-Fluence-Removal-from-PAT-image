...
if __name__ == "__main__":
    ...
    # -*- coding: utf-8 -*-
"""
Created on Sat Feb 19 23:39:27 2022
...
def Y_net(I,f,R):
        ...
        #encoder2
    inputB = Input(shape=(128,2048,1))
    E1 = conv(inputB,f) #128, 2048, 32
    # print(E1.shape)
    E2 = c1(E1,2*f)#64, 1024, 64
    # print(E2.shape)
    E3 = c1(E2,4*f)#32, 512, 128
    # print(E3.shape)
    E4 = c1(E3,8*f)#16, 256, 256
    # print(E4.shape)
    E5 = c1(E4,8*f)#16, 128, 256
    # print(E5.shape)
    ...
    # #Resize
    # R0 = Conv2D(filters=16*f, kernel_size=(1,8), strides=(1,8), padding='valid')(E6)
    R1 = Conv2D(filters=8*f, kernel_size=(1,16), strides=(1,16), padding='valid')(E5)#16, 16, 256
    print(R1.shape)
    R2 = Conv2D(filters=8*f, kernel_size=(1,16), strides=(1,16), padding='valid')(E4)
    # print(R2.shape)
    R3 = Conv2D(filters=4*f, kernel_size=(1,16), strides=(1,16), padding='valid')(E3)
    R4 = Conv2D(filters=2*f, kernel_size=(1,16), strides=(1,16), padding='valid')(E2)
    R5 = Conv2D(filters=1*f, kernel_size=(1,16), strides=(1,16), padding='valid')(E1)
